              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-2">
                    <p>
                      <span className="font-medium">Email:</span> {selectedStudent.userId.email}
                    </p>
                    {selectedStudent.userId.phone && (
                      <p>
                        <span className="font-medium">Phone:</span> {selectedStudent.userId.phone}
                      </p>
                    )}
                    {selectedStudent.healthNotes && (
                      <div className="mt-3 p-3 bg-red-50 border border-red-200 rounded">
                        <p className="text-xs font-medium text-red-600 mb-1">Health Notes</p>
                        <p className="text-sm text-red-700">{selectedStudent.healthNotes}</p>
                      </div>
                    )}
                    {selectedStudent.emergencyContact && (
                      <div className="mt-3 p-3 bg-blue-50 border border-blue-200 rounded">
                        <p className="text-xs font-medium text-blue-600 mb-1">Emergency Contact</p>
                        <p className="text-sm text-blue-700">{selectedStudent.emergencyContact}</p>
                      </div>
                    )}
